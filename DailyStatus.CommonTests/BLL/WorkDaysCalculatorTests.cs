...
namespace DailyStatus.Common.BLL.Tests
{
    ...
    public class WorkDaysCalculatorTests
    {
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2018, 03, 24, 5, 5, 5), TimeSpan.FromHours(10), 8, new List<DateTime>());
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2018, 03, 23, 20, 0, 0), TimeSpan.FromHours(8), 8, new List<DateTime>());
            var expected = TimeSpan.FromHours(136);
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2018, 03, 23, 02, 0, 0), TimeSpan.FromHours(10), 8, new List<DateTime>());
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2018, 03, 26, 8, 0, 0), TimeSpan.FromHours(10), 8, new List<DateTime>());
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2018, 03, 26, 14, 0, 0), TimeSpan.FromHours(10), 8, new List<DateTime>());
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2018, 03, 26, 11, 0, 0), TimeSpan.FromHours(10), 8, new List<DateTime>());
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(new DateTime(2019, 03, 8, 15, 0, 0), TimeSpan.FromHours(10), 8, new List<DateTime>());
        ...
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(
        ...
        public void Given3_12_2019_12_00_With6HoursWeek_ShouldReturn8()
        {
            var actual = new WorkDaysCalculator().ThisMonthExpectedHours(
             ...
             workDayStartHour: TimeSpan.FromHours(10),
             numberOfWorkingHoursPerDay: 6, holidays: new List<DateTime>());
